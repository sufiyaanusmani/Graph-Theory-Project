...
def bipartiteGraphButtonClicked():
    ...
    canvas.create_line(canvasDimension // 2, 0,  canvasDimension // 2, canvasDimension, width=1, fill="black")
...
def tripartiteGraphButtonClicked():
    ...
    radio_button1.grid(row=2, column=0, padx=10, pady=10, sticky="w")
    radio_button2.grid(row=2, column=1, padx=10, pady=10, sticky="w")
    canvas.create_line(canvasDimension // 3, 0,  canvasDimension // 3, canvasDimension, width=1, fill="black")
    canvas.create_line((canvasDimension // 3) * 2, 0,  (canvasDimension // 3) * 2, canvasDimension, width=1, fill="black")
